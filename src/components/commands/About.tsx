...
import { SiNetlify, SiReact, SiCsswizardry} from "react-icons/si";

export default function About() {
	const techs = [
		{ Icon: SiCsswizardry, color: "text-blue-300", duration: "duration-700" },
	...
	return (
		<div>
			...
			<p className="text-lg animate-reveal-0.7">
				This site is pure written with Html, Css and React. For the
